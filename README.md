Steps How I made this assignment

-> npx create-next-app
then project name as User_Dashboard 

-----------------------------------------

Installed dependencies -> npm i (node_modules)

In this assignment I have used one icon from react-icons for that i used the command 
...
-> npm run dev
after running click on the link 
http://localhost:3000
...
[User Dashboard](https://user-dashboard-ruddy-omega.vercel.app/users)
